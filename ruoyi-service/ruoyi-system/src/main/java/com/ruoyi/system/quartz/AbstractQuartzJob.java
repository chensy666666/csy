...
public abstract class AbstractQuartzJob implements Job
{
    ...
    protected void after(JobExecutionContext context, SysJob sysJob, Exception e)
    {
        ...
        sysJobLog.setCreateTime(sysJob.getCreateTime());
        sysJobLog.setUpdateTime(new Date());
        long runMs = sysJobLog.getUpdateTime().getTime() - sysJobLog.getCreateTime().getTime();
